...
class MyData(Dataset):
    def __init__(self, filepath):
        ...
        self.Y = ts[:, 45:46]  # 44th column as target
        self.len = ts.shape[0]
...
model = DNN3().to('cuda:0')
#print(model)

# Loss function and optimizer
loss_fn = nn.MSELoss()
learning_rate = 0.0006 #设置学习率
...
loss_data.to_excel('loss_data3.xlsx', index=False)'''
...
with pd.ExcelWriter( r'F:\desktop\results_data3.xlsx') as writer:
...
# 保存模型
torch.save(model.state_dict(), r'H:\python\54parameter\DNN-D.pth')
