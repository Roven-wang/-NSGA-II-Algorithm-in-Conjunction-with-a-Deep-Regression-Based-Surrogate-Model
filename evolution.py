from nsga2.nsga2.utils import NSGA2Utils
...
class Evolution:
    ...
    def __init__(self, problem, num_of_generations=6, num_of_individuals=500, num_of_tour_particips=10,
                 tournament_prob=0.9, crossover_param=3, mutation_param=5):
